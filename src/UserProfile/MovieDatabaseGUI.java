...
public class MovieDatabaseGUI extends javax.swing.JFrame {
    ...
    public MovieDatabaseGUI() {
        ...
        FindMovieByChoicePanel.setVisible(false);
        ...
        if(numGenreSug==3){
            for(int u=0;u<movieDataSize-8;u=u+8){
                if(       movieRatingArray[u+3].substring(8,12).equals(Sug[0].substring(0,4))
                        ...
                        ||movieRatingArray[u+5].substring(8,12).equals(Sug[0].substring(0,4))
                        ||movieRatingArray[u+3].substring(8,12).equals(Sug[1].substring(0,4))
                        ||movieRatingArray[u+4].substring(8,12).equals(Sug[1].substring(0,4))
                        ||movieRatingArray[u+5].substring(8,12).equals(Sug[1].substring(0,4))
                        ||movieRatingArray[u+3].substring(8,12).equals(Sug[2].substring(0,4))
                        ||movieRatingArray[u+4].substring(8,12).equals(Sug[2].substring(0,4))
                        ||movieRatingArray[u+5].substring(8,12).equals(Sug[2].substring(0,4))   
                        ){
                    for(int x=0;x<8;x++){
                        movieRatingArray2[u+x]=movieRatingArray[u+x];
                    }
                    //point2=point2+1;
                }
            }
    ...
    private void initComponents() {
        ...
        FindMovieByChoicePanel = new javax.swing.JPanel();
        String[] genrelistS = {"Action","Adventure","Animation","Comedy","Crime","Documentary","Drama", "Family","Fantasy","Film-Noir","History","Horror","Music","Musical","Mystery","Romance","Sci-Fi","Sport","Thriller","War","Western"};
        SpinnerListModel genremodelS = new SpinnerListModel(genrelistS);
        Genre1SpinnerS1 = new javax.swing.JSpinner(genremodelS);
        //String[] genrelist = {"Action","Adventure","Animation","Comedy","Crime","Documentary","Drama", "Family","Fantasy","Film-Noir","History","Horror","Music","Musical","Mystery","Romance","Sci-Fi","Sport","Thriller","War","Western"};
        SpinnerListModel genremodelS2 = new SpinnerListModel(genrelistS);
        Genre2SpinnerS2 = new javax.swing.JSpinner(genremodelS2);
        //String[] genrelist = {"Action","Adventure","Animation","Comedy","Crime","Documentary","Drama", "Family","Fantasy","Film-Noir","History","Horror","Music","Musical","Mystery","Romance","Sci-Fi","Sport","Thriller","War","Western"};
        SpinnerListModel genremodelS3 = new SpinnerListModel(genrelistS);
        Genre3SpinnerS3 = new javax.swing.JSpinner(genremodelS3);
        ChooseGenresLabelSuggest = new javax.swing.JLabel();
        SpinnerModel modelSuggest =
        new SpinnerNumberModel(1, //initial value
            1, //min
            3, //max
            1);
        NumGenresSpinnerSuggest = new javax.swing.JSpinner(modelSuggest);
        NumGenresLabelSuggest = new javax.swing.JLabel();
        ShowMeMoviesSuggestion = new javax.swing.JButton();
        ChooseSuggestionsToHome = new javax.swing.JButton();
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, ChooseGenresLabel, org.jdesktop.beansbinding.ELProperty.create("${alignmentX}"), ChooseGenresLabel, org.jdesktop.beansbinding.BeanProperty.create("horizontalAlignment"));
        ...
        FindMovieByChoicePanel.setBackground(new java.awt.Color(255, 102, 0));

        ChooseGenresLabelSuggest.setFont(new java.awt.Font("PilGi", 0, 24)); // NOI18N
        ChooseGenresLabelSuggest.setForeground(new java.awt.Color(255, 255, 255));
        ChooseGenresLabelSuggest.setText("Choose genres:");

        NumGenresSpinnerSuggest.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                NumGenresSpinnerSuggestStateChanged(evt);
            }
        });

        NumGenresLabelSuggest.setFont(new java.awt.Font("PilGi", 0, 24)); // NOI18N
        NumGenresLabelSuggest.setForeground(new java.awt.Color(255, 255, 255));
        NumGenresLabelSuggest.setText("Number of Movie Genres?");

        ShowMeMoviesSuggestion.setText("Find me Movies From These!");
        ShowMeMoviesSuggestion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ShowMeMoviesSuggestionActionPerformed(evt);
            }
        });

        ChooseSuggestionsToHome.setText("I want to do something else!");
        ChooseSuggestionsToHome.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChooseSuggestionsToHomeActionPerformed(evt);
            }
        });

        javax.swing.GroupLayout FindMovieByChoicePanelLayout = new javax.swing.GroupLayout(FindMovieByChoicePanel);
        FindMovieByChoicePanel.setLayout(FindMovieByChoicePanelLayout);
        FindMovieByChoicePanelLayout.setHorizontalGroup(
            FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(FindMovieByChoicePanelLayout.createSequentialGroup()
                .addContainerGap(51, Short.MAX_VALUE)
                .addGroup(FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(ChooseSuggestionsToHome, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ShowMeMoviesSuggestion, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(FindMovieByChoicePanelLayout.createSequentialGroup()
                        .addGroup(FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(FindMovieByChoicePanelLayout.createSequentialGroup()
                                .addComponent(ChooseGenresLabelSuggest)
                                .addGap(18, 18, 18)
                                .addComponent(Genre1SpinnerS1, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18))
                            .addGroup(FindMovieByChoicePanelLayout.createSequentialGroup()
                                .addComponent(NumGenresLabelSuggest, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                        .addGroup(FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(NumGenresSpinnerSuggest, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(Genre2SpinnerS2, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(18, 18, 18)
                .addComponent(Genre3SpinnerS3, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(37, 37, 37))
        );
        FindMovieByChoicePanelLayout.setVerticalGroup(
            FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(FindMovieByChoicePanelLayout.createSequentialGroup()
                .addGap(98, 98, 98)
                .addGroup(FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(NumGenresLabelSuggest, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(NumGenresSpinnerSuggest, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Genre1SpinnerS1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Genre2SpinnerS2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Genre3SpinnerS3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ChooseGenresLabelSuggest))
                .addGap(43, 43, 43)
                .addComponent(ShowMeMoviesSuggestion)
                .addGap(18, 18, 18)
                .addComponent(ChooseSuggestionsToHome)
                .addContainerGap(363, Short.MAX_VALUE))
        );

        Genre2SpinnerS2.setVisible(false);
        Genre3SpinnerS3.setVisible(false);

        getContentPane().add(FindMovieByChoicePanel, "card8");
    ...
    private void SuggestionButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        ...
        FindMovieByChoicePanel.setVisible(true);
        
    }                                                

    private void HomeReviewButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        // TODO add your handling code here:
        String entered = LoginUsernameTextField.getText();
        HomePagePanel.setVisible(false);
        NumGenresSpinner.setValue(1);
    ...
    private void FindFriendsButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        // TODO add your handling code here:
        // This is the Friends please button
    }                                                 

    private void HomeToMoviesButtomActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        // TODO add your handling code here:
        readFile();
        HomePagePanel.setVisible(false);
    ...
    private void ReviewToHomeButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        // TODO add your handling code here:
        ReviewPanel.setVisible(false);
        HomePagePanel.setVisible(true);
    }                                                  

    private void DatabaseLogoutButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        // TODO add your handling code here:
        currentUser = null;
        MovieDatabasePanel.setVisible(false);
        LoginPanel.setVisible(true);
    ...
    private void DatabaseToHomeButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        // TODO add your handling code here:
        MovieDatabasePanel.setVisible(false);
        HomePagePanel.setVisible(true);
    }                                                    

    private void SuggestLogoutButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        // TODO add your handling code here:
        currentUser = null;
        SuggestMoviePanel.setVisible(false);
        LoginPanel.setVisible(true);
    ...
    private void SuggestMovieToHomeButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                         
        // TODO add your handling code here:
        SuggestMoviePanel.setVisible(false);
        HomePagePanel.setVisible(true);
    }                                                        

    private void NumGenresSpinnerSuggestStateChanged(javax.swing.event.ChangeEvent evt) {                                                     
        // TODO add your handling code here:
        int numGenresSuggest = (int)NumGenresSpinnerSuggest.getValue();
        
        switch(numGenresSuggest)
        {
            case 2:
                Genre1SpinnerS1.setVisible(true);
                Genre2SpinnerS2.setVisible(true);
                Genre3SpinnerS3.setVisible(false);
                break;
            case 3:
                Genre1SpinnerS1.setVisible(true);
                Genre2SpinnerS2.setVisible(true);
                Genre3SpinnerS3.setVisible(true);
                break;
            default:
                Genre1SpinnerS1.setVisible(true);
                Genre2SpinnerS2.setVisible(false);
    ...
    private void ShowMeMoviesSuggestionActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        // TODO add your handling code here:
        if((int)NumGenresSpinnerSuggest.getValue() ==1)
            {Sug[0] = (String)Genre1SpinnerS1.getValue();numGenreSug=1;}
        else if ((int)NumGenresSpinner.getValue() ==2)
            {Sug[0] = (String)Genre1SpinnerS1.getValue();Sug[1] = (String)Genre2SpinnerS2.getValue();numGenreSug=2;}
        else
            {Sug[0] = (String)Genre1SpinnerS1.getValue();Sug[1] = (String)Genre2SpinnerS2.getValue();Sug[2] = (String)Genre3SpinnerS3.getValue();numGenreSug=3;}
        SortMovieByRatingwithGenre();
        FindMovieByChoicePanel.setVisible(false);
        SuggestMoviePanel.setVisible(true);
    }                                                      

    private void ChooseSuggestionsToHomeActionPerformed(java.awt.event.ActionEvent evt) {                                                        
        // TODO add your handling code here:
        FindMovieByChoicePanel.setVisible(false);
        HomePagePanel.setVisible(true);
    }                                                       
    ...
    private void initComponents2() 
    {
        ...
        FindMovieByChoicePanelLayout.setHorizontalGroup(
            FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, FindMovieByChoicePanelLayout.createSequentialGroup()
                .addContainerGap(51, Short.MAX_VALUE)
                .addGroup(FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(ChooseSuggestionsToHome, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ShowMeMoviesSuggestion, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(FindMovieByChoicePanelLayout.createSequentialGroup()
                        .addGroup(FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, FindMovieByChoicePanelLayout.createSequentialGroup()
                                ...
                                .addComponent(Genre1SpinnerS1, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(12, 12, 12))
                            .addComponent(NumGenresLabelSuggest, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(FindMovieByChoicePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(NumGenresSpinnerSuggest, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(Genre2SpinnerS2, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private javax.swing.JLabel ChooseGenresLabelSuggest;
    private javax.swing.JButton ChooseSuggestionsToHome;
    ...
    private javax.swing.JPanel FindMovieByChoicePanel;
    private javax.swing.JSpinner Genre1Spinner;
    private javax.swing.JSpinner Genre1SpinnerS1;
    private javax.swing.JSpinner Genre2Spinner;
    private javax.swing.JSpinner Genre2SpinnerS2;
    private javax.swing.JSpinner Genre3Spinner;
    private javax.swing.JSpinner Genre3SpinnerS3;
    ...
    private javax.swing.JLabel NumGenresLabelSuggest;
    private javax.swing.JSpinner NumGenresSpinner;
    private javax.swing.JSpinner NumGenresSpinnerSuggest;
    ...
    private javax.swing.JButton ShowMeMoviesSuggestion;
